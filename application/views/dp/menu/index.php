                                ...
                                <?php foreach ($menu as $menu) : ?>
                                    <tr>
                                        ...
                                        <td style="width:25% ;">
                                            ...
                                            <a href="<?= base_url(); ?>menu/edit/<?= $menu['id_user_menu']; ?>" class="badge bg-success">Ubah</a>
                                            <a href="<?= base_url(); ?>menu/delete/<?= $menu['id_user_menu']; ?>" class="badge bg-danger hapus-news">Hapus</a>
                                        </td>
