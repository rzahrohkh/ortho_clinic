                ...
                <div class="row">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Sub Menu Baru</h4>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <form method="POST" action="<?= base_url() ?>subMenu/add" class="needs-validation" novalidate="">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" required autofocus placeholder="Masukkan Nama Sub Menu" tabindex="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="url" class="form-control" required autofocus placeholder="Masukkan URL sub menu">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="icon" class="form-control" required autofocus placeholder="Masukkan Icon Sub Menu">
                                            <div class="invalid-feedback">
