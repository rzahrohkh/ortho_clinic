                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= base_url(); ?>users/add" class="needs-validation" novalidate="">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="name" class="form-control" required autofocus tabindex="1" placeholder="Masukkan nama">
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="username" class="form-control" required autofocus tabindex="1" placeholder="Masukkan username">
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="password" class="form-control" required autofocus tabindex="1" placeholder="Masukkan password">
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tanggal
                                        lahir</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input class="form-control" type="date" name="date_of_birth" value="2021-01" id="example-month-input" name="date_of_birth" required autofocus>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" name="age" class="form-control" required autofocus tabindex="1" placeholder="Masukan umur">
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea class="form-control" id="address" name="address" require required placeholder="Masukkan Alamat"></textarea>
                                    </div>
                                </div>
