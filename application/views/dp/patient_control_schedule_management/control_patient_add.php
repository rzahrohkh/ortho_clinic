                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="<?= base_url() ?>PatientControlScheduleManagement/add" class="needs-validation" novalidate="">
                                       ...
                                       <div class="form-group row mb-4">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input class="form-control" type="date" id="example-month-input"  name="date_control_patient" required autofocus>
