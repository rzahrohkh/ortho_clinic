            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <!-- <div class="d-flex flex-row-reverse" style="margin-right: 3% ; margin-button: 1%;">
                        <a href="<?= base_url(); ?>drugs/add" class="btn btn-success"> + Tambah section baru</a>
                    </div> -->
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($section as $section) : ?>
                                    <tr>
                                        ...
                                        <td style="width:15% ;">
                                            <a href="<?= base_url(); ?>Section/edit/<?= $section['id_section']; ?>" class="badge bg-success">Ubah</a>
                                            <!-- <a href="<?= base_url(); ?>Section/delete/<?= $section['id_section']; ?>" class="badge bg-danger hapus-news">Hapus</a> -->
                                        </td>
