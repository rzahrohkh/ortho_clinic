...
<div>
    <div id="table">
    <div id="top">  
       <h6>Laporan Aktiftias Pasien<h6>
    </div>
</div>
...
<table class="table table-bordered border" id="table1">
    <thead>
        <tr>
            <th class="border">Nomor Aktifitas</th>
            <th class="border">Tanggal Aktifitas</th>
            <th class="border">Tipe Aktifitas</th>
    ...
    <tbody>
        ...
        <?php foreach ($activities as $activities) : ?>
            <tr  class="border">
            <td class="border"><?= $activities['id_activity_patient'] ?></td>
            <td class="border"><?= $activities['date_activity_patient'] ?></td>
            <td class="border"><?= $activities['activity_type'] ?></td>
            <td class="border"><?= $activities['activity_question'] ?></td>
            </tr>
        <?php $i++; ?>
        <?php endforeach; ?>
    </tbody>
