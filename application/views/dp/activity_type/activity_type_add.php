                ...
                <div class="row">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Tipe Aktivitas Baru</h4>
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form method="POST" action="<?= base_url() ?>ActivityType/add" class="needs-validation" novalidate="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="basicInput" name="activity_type" require required placeholder="Masukkan Tipe Aktivitas">
