...
<table class="table table-bordered border" id="table1">
    <thead>
        <tr>
<!-- "tanggal_aktifitas", "id_patient", "nama_pasien", "tipe_aktifitas", "aktifitas_yang_dilakukan" -->
            <th class="border">tanggal_submit</th>
            <th class="border">id_patient</th>
            <th class="border">nama_pasien</th>
            <th class="border">tipe_aktifitas</th>
            <th class="border">aktifitas_yang_dilakukan</th>
    ...
    <tbody>
        ...
        <?php foreach ($aktifitas as $aktifitas) : ?>
            <tr  class="border">
                <td class="border"><?= $aktifitas['date_activity_patient'] ?></td>
                <td class="border"><?= $aktifitas['id_patient'] ?></td>
                <td class="border"><?= $aktifitas['name_patient'] ?></td>
                <td class="border"><?= $aktifitas['activity_type'] ?></td>
                <td class="border"><?= $aktifitas['answer'] ?></td>
            </tr>
        <?php $i++; ?>
        <?php endforeach; ?>
    </tbody>
