...
<div>
    <div id="table">
    <div id="top">  
       <h6>Laporan Rekam Medis Pasien<h6>
    </div>
</div>
<table class="table table-bordered border" id="table1">
    <thead>
        <tr>
            <th class="border">id_rekam_medis</th>
            <th class="border">nama_pasien</th>
            <th class="border">tanggal_pemeriksaan</th>
            <th class="border">diagnosis</th>
            <th class="border">jenis_penanganan</th>
            <th class="border">status_rekam_medis</th>
            <th class="border">penanganan</th>
            <th class="border">biaya_pemeriksaan</th>
            <th class="border">nama_dokter</th>
        </tr>
    </thead>
    <tbody>
        <?php $i = 1; ?>
        <?php foreach ($medicalRecord as $medicalRecord) : ?>
            ...
            <td class="border"><?= $medicalRecord['name_patient'] ?></td>
